...
namespace FridgeCompanionV2Api.Controllers
{
    ...
    public class StatsController : ApiControllerBase
    {
        ...
        public StatsController(ILogger<StatsController> logger, ICurrentUserService currentUserService)
        {
        ...
        [HttpGet()]
        public async Task<ActionResult<StatDto>> Get(string duration)
        {
            GetStatsQuery query = new GetStatsQuery() { Duration = duration };
