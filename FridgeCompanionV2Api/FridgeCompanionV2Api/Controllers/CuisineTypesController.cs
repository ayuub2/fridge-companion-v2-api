...
namespace FridgeCompanionV2Api.Controllers
{
    ...
    [ApiController]
    [Route("[controller]")]
    public class CuisineTypesController : ApiControllerBase
    {

        private readonly ILogger<CuisineTypesController> _logger;
        private readonly ICurrentUserService _currentUserService;

        public CuisineTypesController(ILogger<CuisineTypesController> logger, ICurrentUserService currentUserService)
        {
        ...
        [HttpGet()]
        public async Task<ActionResult<List<CuisineTypeDto>>> GetItems()
        {
            GetCuisineTypesQuery query = new GetCuisineTypesQuery();
